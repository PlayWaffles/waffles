...
const ANNOUNCEMENTS = [
  ...
  { id: "whats-new-v2", title: "Welcome to Waffles", body: "Here's what you can do: climb the level path, earn XP as you play, and collect Syrup to spend in the shop. There's a new tournament every 4 hours, daily missions to knock out, and daily rewards & streaks for showing up.", sortOrder: 35, tone: "maple", emoji: "🧇", ctaLabel: "Take a look", ctaAction: "screen:home" },
  { id: "world-cup-season", title: "The World Cup is here", body: "Football trivia, live every 4 hours, with real prizes on the line. See what's new this season.", sortOrder: 40, tone: "leaf", emoji: "⚽", ctaLabel: "See what's new", ctaAction: "theme:world-cup" },
