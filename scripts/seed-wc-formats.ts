...
const ordering: Row[] = [
  ...
  ord("Order these WC top scorers — fewest goals to most.", ["Klose (16)", "Ronaldo (15)", "G. Müller (14)", "Fontaine (13)"], [3, 2, 1, 0], "HARD"),
  ...
  ord("Order by title count — fewest to most.", ["England (1)", "Italy (4)", "Uruguay (2)", "Brazil (5)"], [0, 2, 1, 3], "EASY"),
  ord("Order these hosts 2010→2022 — earliest first.", ["Brazil", "South Africa", "Russia", "Qatar"], [1, 0, 2, 3], "MEDIUM"),
  ord("Order Golden Boot winners — earliest first.", ["Kane (2018)", "Ronaldo (2002)", "Mbappé (2022)", "T. Müller (2010)"], [1, 3, 0, 2], "HARD"),
  ord("Order these World-Cup-winning coaches — earliest first.", ["Scaloni (2022)", "Deschamps (2018)", "Löw (2014)", "Del Bosque (2010)"], [3, 2, 1, 0], "MEDIUM"),
  ord("Order Messi's World Cups — earliest first.", ["2014", "2006", "2022", "2018"], [1, 0, 3, 2], "MEDIUM"),
  ord("Order these record wins by year — earliest first.", ["Germany 7-1 Brazil (2014)", "Hungary 10-1 El Salvador (1982)", "Yugoslavia 9-0 Zaire (1974)", "Spain 7-0 Costa Rica (2022)"], [2, 1, 0, 3], "HARD"),
  ord("Order these debut hosts — earliest first.", ["Qatar (2022)", "South Africa (2010)", "Japan/Korea (2002)", "USA (1994)"], [3, 2, 1, 0], "MEDIUM"),
  ord("Order these African milestones — earliest first.", ["Cameroon QF (1990)", "Senegal QF (2002)", "Ghana QF (2010)", "Morocco SF (2022)"], [0, 1, 2, 3], "MEDIUM"),
  ord("Order these iconic teams' eras — earliest first.", ["Brazil (1970)", "Netherlands (1974)", "Argentina (1986)", "France (1998)"], [0, 1, 2, 3], "EASY"),
  ord("Order Spain's, France's, Italy's, Germany's last title — earliest first.", ["Spain (2010)", "France (2018)", "Italy (2006)", "Germany (2014)"], [2, 0, 3, 1], "MEDIUM"),
  ord("Order these venues' finals by year — earliest first.", ["Maracanã (2014)", "Lusail (2022)", "Azteca (1986)", "Stade de France (1998)"], [2, 3, 0, 1], "HARD"),
  ord("Order these mascots' tournaments — earliest first.", ["Zakumi (2010)", "Footix (1998)", "Fuleco (2014)", "La'eeb (2022)"], [1, 0, 2, 3], "HARD"),
...
const triviaBingo: Row[] = [
  ...
  bingo("Tap the 3 here who WON the World Cup as host.", ["France", "Belgium", "Argentina (1978)", "Portugal", "England (1966)", "Mexico"], [0, 2, 4], "MEDIUM"),
  bingo("Tap the 4 here that won the trophy this century.", ["Brazil", "Italy", "Greece", "Spain", "Denmark", "Germany"], [0, 1, 3, 5], "MEDIUM"),
  bingo("Tap the 3 keepers here who won the Golden Glove.", ["E. Martínez (2022)", "Modrić", "Courtois (2018)", "Kane", "Neuer (2014)", "Hazard"], [0, 2, 4], "HARD"),
