...
export const FORMATS: FormatDef[] = [
...

  {
    ...
    id: "timed-list",
    name: "Timed List",
    tagline: "Type as many correct answers as you can.",
    tier: "expansion",
    engine: "timed-list",
    accent: "green",
  },
  ...
  },
  {
    num: 17,
    id: "crossword",
    name: "Crossword / Word Puzzle",
    tagline: "Clue-based word grid.",
    tier: "expansion",
    engine: "crossword",
    accent: "green",
  },
...
export const TIMED_LIST = {
  prompt: "Name countries that have WON the World Cup",
  durationSec: 45,
  /** Canonical answers + accepted aliases (compared case/space-insensitively). */
  answers: [
    { label: "Brazil", aliases: ["brazil"] },
    { label: "Germany", aliases: ["germany", "west germany"] },
    { label: "Italy", aliases: ["italy"] },
    { label: "Argentina", aliases: ["argentina"] },
    { label: "France", aliases: ["france"] },
    { label: "Uruguay", aliases: ["uruguay"] },
    { label: "England", aliases: ["england"] },
...
export const CROSSWORD = {
  prompt: "Fill the grid from the clues",
  size: 4,
  entries: [
    {
      number: 1,
      dir: "across" as const,
      clue: "England striker, 2018 Golden Boot winner",
      answer: "KANE",
      row: 0,
      col: 0,
    },
    {
      number: 1,
      dir: "down" as const,
      clue: "Brazil's 2002 playmaker, AC Milan #22",
      answer: "KAKA",
      row: 0,
      col: 0,
    },
