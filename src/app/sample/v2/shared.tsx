...
export const ASSETS = {
  ...
  checkmark: `${ASSETS_BASE}/checkmark.webp`,
  lock: `${ASSETS_BASE}/lock.webp`,
  vipStar: `${ASSETS_BASE}/vip-star.webp`,
  xpGem: `${ASSETS_BASE}/xp-gem.webp`,
  ...
  iconTarget: `${ASSETS_BASE}/icon-target.webp`,
  iconCalendar: `${ASSETS_BASE}/icon-calendar.webp`,
  coin: "/images/illustrations/golden-coin.webp",
  ...
  wallyStump: `${ASSETS_BASE}/wally-stump.webp`,
