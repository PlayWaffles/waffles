...
export const ASSETS = {
  wally: `${ASSETS_BASE}/wally.webp`,
  ticket: `${ASSETS_BASE}/ticket.webp`,
  flame: `${ASSETS_BASE}/flame.webp`,
  trophy: `${ASSETS_BASE}/trophy.webp`,
  heartFull: `${ASSETS_BASE}/heart-full.webp`,
  heartEmpty: `${ASSETS_BASE}/heart-empty.webp`,
  heartBroken: `${ASSETS_BASE}/heart-broken.webp`,
  ...
  powerup5050: `${ASSETS_BASE}/powerup-5050.webp`,
  powerupTime: `${ASSETS_BASE}/powerup-time.webp`,
  powerupSkip: `${ASSETS_BASE}/powerup-skip.webp`,
  powerupShield: `${ASSETS_BASE}/powerup-shield.webp`,
  chestRainbow: `${ASSETS_BASE}/chest-rainbow.webp`,
  chestPurple: `${ASSETS_BASE}/chest-purple.webp`,
  chestBrown: `${ASSETS_BASE}/chest-brown.webp`,
  medalApprentice: `${ASSETS_BASE}/medal-apprentice.webp`,
  medalSilver: `${ASSETS_BASE}/medal-silver.webp`,
  medalAdvanced: `${ASSETS_BASE}/medal-advanced.webp`,
  medalGenius: `${ASSETS_BASE}/medal-genius.webp`,
  medalMaster: `${ASSETS_BASE}/medal-master.webp`,
  avatarFox: `${ASSETS_BASE}/avatar-fox.webp`,
  avatarBear: `${ASSETS_BASE}/avatar-bear.webp`,
  avatarFrog: `${ASSETS_BASE}/avatar-frog.webp`,
  avatarPanda: `${ASSETS_BASE}/avatar-panda.webp`,
  avatarOwl: `${ASSETS_BASE}/avatar-owl.webp`,
  avatarCat: `${ASSETS_BASE}/avatar-cat.webp`,
  avatarDog: `${ASSETS_BASE}/avatar-dog.webp`,
  avatarRabbit: `${ASSETS_BASE}/avatar-rabbit.webp`,
  bossNightOwl: `${ASSETS_BASE}/boss-night-owl.webp`,
  ...
  forestFloorTile: `${ASSETS_BASE}/forest-floor-tile.webp`,
  cloud: `${ASSETS_BASE}/cloud.webp`,
  terrainStone: `${ASSETS_BASE}/terrain-stone.webp`,
  forestCabin: `${ASSETS_BASE}/forest-cabin.webp`,
  forestPond: `${ASSETS_BASE}/forest-pond.webp`,
  forestFrog: `${ASSETS_BASE}/forest-frog.webp`,
  forestTreePine: `${ASSETS_BASE}/forest-tree-pine.webp`,
  forestTreeBush: `${ASSETS_BASE}/forest-tree-bush.webp`,
  forestMushroom: `${ASSETS_BASE}/forest-mushroom.webp`,
  forestFlowers: `${ASSETS_BASE}/forest-flowers.webp`,
  forestStump: `${ASSETS_BASE}/forest-stump.webp`,
  forestSignpost: `${ASSETS_BASE}/forest-signpost.webp`,
  forestFirefly: `${ASSETS_BASE}/forest-firefly.webp`,
  forestMoon: `${ASSETS_BASE}/forest-moon.webp`,
  wallyStump: `${ASSETS_BASE}/wally-stump.webp`,
  // Isometric waffle path slabs (3D-rendered tiles for the levels world)
  waffleSlabActive: `${ASSETS_BASE}/waffle-slab-active.webp`,
  waffleSlabDone: `${ASSETS_BASE}/waffle-slab-done.webp`,
  waffleSlabLocked: `${ASSETS_BASE}/waffle-slab-locked.webp`,
} as const;
