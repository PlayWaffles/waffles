...
const decorations: Decoration[] = [
  {
    src: "/images/player/forest-tree-pine.webp",
    alt: "",
    x: 7,
    y: 2,
    size: 170,
  ...
  {
    src: "/images/player/forest-tree-bush.webp",
    alt: "",
    x: 1,
    y: 27,
    size: 132,
  ...
  {
    src: "/images/player/forest-pond.webp",
    alt: "",
    x: 60,
    y: 36,
    size: 176,
  ...
  {
    src: "/images/player/forest-frog.webp",
    alt: "",
    x: 79,
    y: 39,
    size: 42,
  ...
  {
    src: "/images/player/forest-flowers.webp",
    alt: "",
    x: 72,
    y: 58,
    size: 64,
  ...
  {
    src: "/images/player/forest-cabin.webp",
    alt: "",
    x: 61,
    y: 116,
    size: 176,
  ...
  {
    src: "/images/player/forest-signpost.webp",
    alt: "",
    x: 40,
    y: 96,
    size: 56,
  ...
  {
    src: "/images/player/forest-mushroom.webp",
    alt: "",
    x: 77,
    y: 111,
    size: 40,
    ...
    >
      ...
      {isCurrent ? (
        <img
          ...
          src="/images/player/avatar-frog.webp"
          alt=""
          draggable={false}
        />
      ) : null}
    ...
    <header className={styles.topChrome}>
      <div className={styles.statusBar} aria-hidden="true">
        ...
        <div className={styles.dynamicIsland}>
          <img src="/images/player/avatar-owl.webp" alt="" draggable={false} />
          <span />
        </div>
      ...
      <div className={styles.titleRow}>
        <span className={styles.ticketBadge}>
          <img src="/images/player/ticket.webp" alt="" draggable={false} />
          7
        </span>
        <h1>Puzzles</h1>
      </div>
...
function CoachBubble() {
  return (
    <div className={styles.coach}>
      <img src="/images/player/wally.webp" alt="" draggable={false} />
  ...
  return (
    <div className={styles.scoreRail} aria-label="Puzzle progress">
      <div>
        <strong>707</strong>
        <span>
          <img src="/images/player/flame.webp" alt="" draggable={false} />
          12
        </span>
      </div>
      ...
      <span className={styles.smallTicket}>
        <img src="/images/player/ticket.webp" alt="" draggable={false} />8
      </span>
    </div>
  );
}
