      ...
      {node.state === "current" && (
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background: "radial-gradient(ellipse, rgba(255, 210, 77, 0.55), transparent 65%)",
        ...
        <>
          <div
            ...
            style={{
              ...
              transform: "translate(-50%, -50%)",
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(255,255,255,0.95), rgba(255,210,77,0.5) 45%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              transform: "translate(-50%, -50%)",
              borderRadius: "50%",
              border: "3px solid rgba(255, 210, 77, 0.9)",
