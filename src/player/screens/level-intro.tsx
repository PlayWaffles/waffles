...
export const LevelIntroScreen = () => {
  ...
  return (
    <Phone statusDark>
      ...
      <div style={{ position: "absolute", inset: 0, backgroundImage: "conic-gradient(from 90deg at 50% 35%, rgba(255,210,77,.12) 0deg, transparent 30deg, transparent 60deg, rgba(255,210,77,.08) 90deg, transparent 120deg, transparent 150deg, rgba(255,210,77,.12) 180deg, transparent 210deg, transparent 240deg, rgba(255,210,77,.08) 270deg, transparent 300deg, transparent 330deg)", mixBlendMode: "screen", opacity: 0.7 }} />
      ...
      <div style={{ position: "absolute", top: 96, left: 0, right: 0, textAlign: "center", color: "#fff" }}>
        <div style={{ fontFamily: "var(--font-display)", fontSize: 14, letterSpacing: 3, color: "#FFD24D" }}>LEVEL {levelNum}</div>
        <div style={{ fontFamily: "var(--font-hero)", fontWeight: 800, fontSize: 42, letterSpacing: 0.5, lineHeight: 1, marginTop: 6, textShadow: "0 0 30px rgba(255,210,77,.4)" }}>
      ...
      <div style={{ position: "absolute", top: 236, left: "50%", transform: "translateX(-50%)", width: 172, height: 172 }}>
        <div style={{ position: "absolute", bottom: -20, left: "50%", transform: "translateX(-50%)", width: 200, height: 50, borderRadius: "50%", background: "radial-gradient(ellipse at center, rgba(255,210,77,.5), transparent 65%)" }} />
        ...
        <div style={{ position: "absolute", top: -8, right: -8, width: 48, height: 48, borderRadius: 99, background: "linear-gradient(180deg, #FFD24D, #F5A91B)", border: "3px solid #1e1e1e", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-display)", fontSize: 18, color: "#1e1e1e", boxShadow: "0 4px 0 #1e1e1e" }}>{levelNum}</div>
      </div>
      ...
      <div className="bottom-bar" style={{ borderTop: "2px solid rgba(255,210,77,.2)" }}>
